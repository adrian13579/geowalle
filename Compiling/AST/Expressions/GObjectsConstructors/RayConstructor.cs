...
{
    public class RayConstructor : ConstructorExpression
    {
        public RayConstructor(List<Expression> args, CodeLocation codeLoc) : base(args, codeLoc)
        {
        }
        ...
        public override GObject EvaluateOn(ExecutionScope memory,List<CompilingError>errors)
        {
            ...
            {
                errors.Add(new CompilingError(CodeLocation, ErrorCode.Invalid, "El constructor de Ray debe recibir dos puntos"));
                return null;
            }
